...
<head>
	...
	<title>Recursive Paint Fill</title>
...
<body>
<h1>Recursive Paint Fill Function</h1>
<table>
  <col width="700">
  <col width="1000">
   <tr>
      <td>
         <form action="PaintFill" method="POST">
			...
			<p class="outset">Enter nRows (between 3 and 5):
		  	<input type="number" name="nRows" min="3" max="5"> <br><br></p>
		  	
		  	<p class="outset">Enter nColumns (between 3 and 5):
		  	<input type="number" name="nColumns" min="3" max="5"> <br><br></p>
		...
		<form action="PaintFill" method="POST">
			<p style="text-indent: 5em;">
				<p class="outset">Choose a new fill color:
			    <input name="newFillColor" type="hidden" id="color_value" value="99cc00">
			    <button class="jscolor {valueElement: 'color_value'}">Pick a color</button> <br><br></p>
			</p>
		
		    <p style="text-indent: 5em;">
				<p class="outset">Enter paint fill nRows cell:
				<input type="number" name="paintFillnRow" min="0" max="4"> <br><br><p>
			</p>
			
			<p style="text-indent: 5em;">
				<p class="outset">Enter paint fill nColumns cell:
				<input type="number" name="paintFillnColumn" min="0" max="4"> <br><br><p>
			</p>
